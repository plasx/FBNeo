#!/bin/bash
# Simplified FBNeo Metal build script
# This script builds a simplified version that will focus only on getting the window to show

set -e

echo "====================================================="
echo "FBNeo Metal Simplified Build Script"
echo "====================================================="
echo "This script builds a simplified Metal implementation that's guaranteed to work"
echo ""
...
# Step 2: Create a minimal header file for Metal integration
echo "Creating minimal Metal integration header..."
cat > src/burner/metal/metal_minimal.h << 'EOL'
#pragma once
...
# Step 3: Create a simplified Metal implementation
echo "Creating simplified Metal implementation..."
cat > src/burner/metal/fbneo_metal_simple.mm << 'EOL'
...
echo "Building simplified FBNeo Metal implementation..."
clang++ -fobjc-arc -g -O2 -Wall \
    -framework Metal -framework MetalKit -framework Cocoa -framework CoreGraphics \
    src/burner/metal/fbneo_metal_simple.mm \
    -o fbneo_metal_simple

# Step 5: Make executable
chmod +x fbneo_metal_simple

echo ""
if [ -f "fbneo_metal_simple" ]; then
    echo "Build successful! You can now run ./fbneo_metal_simple"
    echo ""
else
    echo "Build failed!"
    exit 1
