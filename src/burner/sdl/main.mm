...
#if defined(ALT_DAT)
	snprintf(filename, sizeof(filename), "FBNeo_-_ALL_SYSTEMS.dat");
	create_datfile(filename, -1);
#endif
	snprintf(filename, sizeof(filename), "FBNeo_-_Arcade.dat");
	create_datfile(filename, DAT_ARCADE_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_MegaDrive.dat");
	create_datfile(filename, DAT_MEGADRIVE_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_PC_ENGINE.dat");
	create_datfile(filename, DAT_PCENGINE_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_TurboGrafx-16.dat");
	create_datfile(filename, DAT_TG16_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_PC_Engine_SuperGrafx.dat");
	create_datfile(filename, DAT_SGX_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_Sega_SG-1000.dat");
	create_datfile(filename, DAT_SG1000_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_ColecoVision.dat");
	create_datfile(filename, DAT_COLECO_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_Sega_Master_System.dat");
	create_datfile(filename, DAT_MASTERSYSTEM_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_Sega_Game_Gear.dat");
	create_datfile(filename, DAT_GAMEGEAR_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_MSX.dat");
	create_datfile(filename, DAT_MSX_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_Sinclair_ZX_Spectrum.dat");
	create_datfile(filename, DAT_SPECTRUM_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_Neogeo.dat");
	create_datfile(filename, DAT_NEOGEO_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_Nintendo_Entertainment_System.dat");
	create_datfile(filename, DAT_NES_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_Nintendo_Famicom_Disk_System.dat");
	create_datfile(filename, DAT_FDS_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_Neo_Geo_Pocket.dat");
	create_datfile(filename, DAT_NGP_ONLY);

	snprintf(filename, sizeof(filename), "FBNeo_-_Fairchild_Channel_F.dat");
	create_datfile(filename, DAT_CHANNELF_ONLY);
#endif
}
