...
# Emit header
print OUTFILE "// This file was generated by $0 (perl $])\n\n";
print OUTFILE "// Declaration of all drivers\n";
print OUTFILE "#define DRV extern struct BurnDriver\n";

# Emit driver declarations
my $Debug = 0;
...
# Emit pDriver array only for non-Metal builds
print OUTFILE "#undef DRV\n";
print OUTFILE "// Structure containing addresses of all drivers\n";
print OUTFILE "// Needs to be kept sorted (using the full game name as the key) to prevent problems with the gamelist in Kaillera\n";
print OUTFILE "#ifndef METAL_BUILD\n";
print OUTFILE "struct BurnDriver* pDriver[] = {\n";
...
# Emit sourcefile table
print OUTFILE "\n// Lookup table containing sourcefiles of all drivers\n";
print OUTFILE "struct game_sourcefile_entry {\n";
print OUTFILE "\tchar game_name[32];\n";
print OUTFILE "\tchar sourcefile[32];\n";
print OUTFILE "};\n\n";
print OUTFILE "static game_sourcefile_entry sourcefile_table[] = {\n";
