...
// We need to have only one copy of each symbol, so we'll use the extern "C" definitions
// with proper exported visibility attributes to ensure they're found by the linker.

// Define our exported functions with C linkage
extern "C" {
    // Z80 functions
