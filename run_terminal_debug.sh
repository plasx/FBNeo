#!/bin/bash
# Script to run fbneo_metal with forced unbuffered terminal output
...
# Use the script command which runs commands in a pseudo-terminal,
# which forces line-buffered output even in GUI apps
